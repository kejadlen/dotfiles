...
```bash
mcporter call 'slack.<function>(param: "value", param2: 123)'
```

**Quote the call expression.** Parentheses have special meaning in bash; wrapping the call in single quotes prevents shell interpretation.

## Common Mistakes

- **Unquoted parentheses cause bash errors.** Always wrap the call in single quotes.
